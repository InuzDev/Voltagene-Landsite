...
import type { SolarPanels } from "app/lib/types";
import { Solar_panels } from "app/const/const";
...
export default function SolarCalculatorClient({ regions }: Props) {
   ...
   const calculatePanels = () => {
      ...
      const selectedPanel = Solar_panels.find(
         (panel: SolarPanels) => panel.id === panelModel,
      );
      const selectedRegion = regions.find(
         (_region: Region) => _region.id === region,
      );
         ...
         <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center mb-10">
               ...
               <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
                  Determine cuántos paneles solares necesita según su consumo
                  energético mensual
               </p>
            </div>
                  ...
                  <div className="space-y-6">
                     <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                           Puedes encontrar este valor en tu factura de
                           electricidad
                        </p>
                     </div>
                     ...
                     <div className="space-y-2">
                        <DropdownSelect
                           ...
                           value={region}
                           onChange={setRegion}
                           options={regions.map((selected: Region) => ({
                              id: selected.id,
                              label: selected.regionName,
                           }))}
                        />
                     ...
                     <div className="space-y-2">
                        <DropdownSelect
                           ...
                           options={Solar_panels.map((panel: SolarPanels) => ({
                              id: panel.id,
                              label: `${panel.power}W`,
                           }))}
                        />
               ...
               <Card className="p-6">
                  ...
                  {result ? (
                     <div className="space-y-6">
                        <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                           ...
                           <div className="mt-4 space-y-3">
                              ...
                              <p className="text-gray-700">
                                 ...
                                 {formatNumber(result.monthlyConsumptionKWh)}{" "}
                                 kWh
                              </p>
                              <p className="text-gray-700">
                                 <span className="font-medium">
                              ...
                              <div className="pt-3 border-t border-green-200">
                                 <p className="text-xl font-bold text-green-800">
                                    Necesitas {formatNumber(result.panelCount)}{" "}
                                    paneles solares
                                 </p>
                                 <p className="text-gray-700">
                        ...
                        <div className="space-y-2">
                           <h3 className="font-medium">
                              ¿Estás listo para empezar a ahorrar en tu factura
                              de la luz?
                           </h3>
                           <p className="text-gray-600 text-sm">
                              Nuestro equipo de expertos está listo para
                              ayudarte a diseñar e instalar tu sistema solar
                              personalizado.
                           </p>
                           <Button
                              onClick={() => {
                     ...
                     <div className="flex flex-col items-center justify-center h-64 text-center text-gray-500">
                        ...
                        <p>
                           Introduce tu consumo y selecciona un modelo de panel
