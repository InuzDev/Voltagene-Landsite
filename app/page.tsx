                ...
                <div ref={heroRef} className="relative w-full h-screen">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 text-white">
                        ...
                        <p className="text-xl md:text-2xl max-w-3xl mb-8">
                            Instalación profesional, limpieza y remodelación para soluciones
                ...
                <section id="projects" className="w-full py-20 px-4 bg-gray-50">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-16">
                            Conoce algunas de nuestras instalaciones solares más recientes y el
                            impacto que han tenido en nuestros clientes.
                        </p>
