            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.8px #ffffff) drop-shadow(0 0 1.6px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.6px #ffffff) drop-shadow(0 0 1.2px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.4px #ffffff) drop-shadow(0 0 0.8px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.7px #ffffff) drop-shadow(0 0 1.4px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.5px #ffffff) drop-shadow(0 0 1px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.3px #ffffff) drop-shadow(0 0 0.6px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.9px #ffffff) drop-shadow(0 0 1.8px #ffffff)',
                    ...
                    <path
                        ...
                        style={{
                            filter: 'drop-shadow(0 0 0.2px #ffffff) drop-shadow(0 0 0.4px #ffffff)',
