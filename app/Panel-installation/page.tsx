...
export default function PanelInstallation() {
   ...
   const steps = [
      ...
      },
      {
         ...
         details:
            "Inversores inteligentes conectan tus paneles con seguimiento en tiempo real.",
      },
      {
         title: "Activación",
         ...
         details:
            "Pruebas completas garantizan rendimiento óptimo antes de la entrega.",
      },
   ];
               ...
               <div className="max-w-4xl mx-auto">
                  <div className="text-center mb-16">
                     ...
                     <p className="text-lg text-gray-600">
                        Observa tu generación de energía en tiempo real y ve
                        exactamente cuánto dinero ahorras cada día
                     </p>
                  </div>
                     ...
                     {[
                        {
                           ...
                           description:
                              "Ve cada kilovatio generado en tiempo real",
                           color: "bg-green-600",
                        },
                        {
                           icon: (
                           ...
                           description:
                              "Tu factura eléctrica reduciéndose cada día",
                           color: "bg-green-500",
                        },
                        {
            ...
            <div className="container mx-auto px-4">
               <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-xl text-gray-600 mb-8">
                     Programa tu consulta y da el primer paso hacia la
