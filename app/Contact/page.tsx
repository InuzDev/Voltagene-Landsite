               ...
               <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-16">
                     ...
                     <p className="text-gray-600 max-w-2xl mx-auto">
                        ¿Tiene alguna pregunta sobre nuestras soluciones
                        solares? Contacte con nuestro equipo y con gusto le
                        ayudaremos.
                     </p>
                  </div>
                     ...
                     <div className="space-y-8">
                        <div>
                           ...
                           <p className="text-gray-600 mb-8">
                              Contáctenos directamente mediante nuestro número
                              de telefono. Nuestro equipo está listo para
                              responder sus preguntas y brindarle las soluciones
